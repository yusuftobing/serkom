...
<body>
     <div class="row px-2 py-2" style="margin-top: 15px;">
          <div class="col-md-12">
               <h2 class="fw-bold py-3 text-center">Laporan Calon <a href="data-peserta.php"
                         class="text-decoration-none"><span class="text-primary">Siswa</span></a></h2>
						...
						?>
                              <tr>
                                   ...
                                   <td style=" text-align:center;">
                                        <?php echo $row['tmp_lahir'] . ', ' . $row['tgl_lahir'] ?></td>
