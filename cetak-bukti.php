     ...
     <div class="container-fluid">
          <div class="row">
               <div class="col-12 text-center py-3">
                    <h2>Bukti <a href="landingpage/index.php" class="text-decoration-none"><span
                                   class="text-primary">Pendaftaran</span></a> </h2>
               </div>
               <div class="col">

                    <table class="table-data" border="0" style="	line-height: 40px;">
                         <tr>
